...
class AppointmentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.appointments.create', compact('pets', 'rooms', 'veterinarians'));
    }
    ...
    public function update(Request $request, Appointment $appointment)
    {
        ...
        return redirect()->route('admin.appointments.index')->with('success', 'Estado de la cita actualizado exitosamente.');
    }
    /**
        ...
        public function edit(Appointment $appointment)
        {
            ...
            return view('admin.appointments.edit', compact('appointment', 'pets', 'rooms', 'veterinarians', 'statuses'));
        }
        ...
        public function destroy(Appointment $appointment)
        {
            ...
            return redirect()->route('admin.appointments.index')->with('success', 'Cita eliminada y recursos liberados exitosamente.');
        }
}