...
class PetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pets.index')->with('success', 'Mascota creada exitosamente.');
    }
    ...
    {
        // Este método rara vez se usa en interfaces de administrador modernas, 
    ...
    public function update(Request $request, Pet $pet)
    {
        ...
        return redirect()->route('admin.pets.index')->with('success', 'Mascota actualizada exitosamente.');
    }
    ...
    public function destroy(Pet $pet)
    {
        ...
        return redirect()->route('admin.pets.index')->with('success', 'Mascota eliminada exitosamente.');
    }
}