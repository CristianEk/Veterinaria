...
class AppointmentController extends Controller
{
    ...
    {
        return view('veterinarians.appointments.index');
    }
    ...
    public function create()
    {
        ...
        return view('veterinarians.appointments.create', compact('pets', 'rooms', 'veterinarians'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('veterinarians.appointments.index')->with('success', 'Cita agendada exitosamente.');
    }
    ...
    public function update(Request $request, Appointment $appointment)
    {
        ...
        return redirect()->route('veterinarians.appointments.index')->with('success', 'Estado de la cita actualizado exitosamente.');
    }
    /**
        ...
        public function show(Appointment $appointment)
        {
            ...
            return view('veterinarians.appointments.show', compact('appointment'));
        }
        ...
        public function edit(Appointment $appointment)
        {
            ...
            return view('veterinarians.appointments.edit', compact('appointment', 'pets', 'rooms', 'veterinarians', 'statuses'));
        }
        ...
        public function destroy(Appointment $appointment)
        {
            ...
            return redirect()->route('veterinarians.appointments.index')->with('success', 'Cita eliminada y recursos liberados exitosamente.');
        }
}