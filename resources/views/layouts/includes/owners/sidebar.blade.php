@php
    ...
    $links = [
        [
            ...
            'active' => request()->routeIs('owners.dashboard'),
        ],
        [
        ...
        [     
            ...
            'href' => route('owners.pets.index'),
            'active' => request()->routeIs('owners.pets.*')
            //'active' => false,
        ],
        [     
            'name' => 'Citas',
            'icon' => 'fa-solid fa-calendar-check',
            'href' => route('owners.appointments.index'),
            'active' => request()->routeIs('owners.appointments.*')
            //'active' => false,
        ],
    ];
@endphp
