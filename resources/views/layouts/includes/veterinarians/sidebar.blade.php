@php
    ...
    $links = [
        [
            ...
            'active' => request()->routeIs('veterinarians.dashboard'),
        ],
        [
        ...
        [  
            ...
            'active' => request()->routeIs('veterinarians.veterinarians.*')
            //'active' => false,
        ],
        [     
            'name' => 'Citas',
            'icon' => 'fa-solid fa-calendar-check',
            'href' => route('veterinarians.appointments.index'),
            'active' => request()->routeIs('veterinarians.appointments.*')
            //'active' => false,
        ],
    ];
@endphp
